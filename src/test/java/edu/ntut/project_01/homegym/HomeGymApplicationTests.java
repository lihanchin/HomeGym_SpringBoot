...
class HomeGymApplicationTests {
    ...
    @Test
    void show() {
        System.out.println(fQARepository.findFQAByCourseCourseId(2));
    }
...
//
//        if(member.isPresent()){
//            Set<Video> courses =member.get()a.getVideo();
//            for(Video v : courses){
...
//        String check = exampleAllInOne.genAioCheckOutALL("5000",1);
//        return check;
//    }
